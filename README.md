...
<div align="center">
	<img src="https://www.svgrepo.com/show/354478/typescript-icon.svg" title="source: svgrepo.com" width="35%"/>
</div>
...
O conteúdo abrange desde os **fundamentos da linguagem TypeScript** até conceitos essenciais para lógica de programação, como:
...
| Aula    | Tema                     |                          Descrição                           |
| ------- | ------------------------ | :----------------------------------------------------------: |
| Aula 01 | Introdução ao TypeScript | Primeiros passos, estrutura básica e <br />saída de dados, arrays e colletions |
| Aula 02 |                          |                                                              |
| Aula 03 |                          |                                                              |
| Aula 04 |                          |                                                              |
| Aula 05 |                          |                                                              |
...
```bash
git clone https://github.com/outwake/IntroducaoTypescript.git
```
...
Desenvolvido por [**Lary, a pioral <3**](https://github.com/outwake)
